...
{
  new (message_memory) a2_controller::msg::ObstacleInfo(_init);
}

void ObstacleInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<a2_controller::msg::ObstacleInfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObstacleInfo_message_member_array[3] = {
  {
    ...
    offsetof(a2_controller::msg::ObstacleInfo, min_distance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(a2_controller::msg::ObstacleInfo, direction),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(a2_controller::msg::ObstacleInfo, current_threshold),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObstacleInfo_message_members = {
  "a2_controller::msg",  // message namespace
  "ObstacleInfo",  // message name
  3,  // number of fields
  sizeof(a2_controller::msg::ObstacleInfo),
...
get_message_type_support_handle<a2_controller::msg::ObstacleInfo>()
{
  return &::a2_controller::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, a2_controller, msg, ObstacleInfo)() {
  return &::a2_controller::msg::rosidl_typesupport_introspection_cpp::ObstacleInfo_message_type_support_handle;
}

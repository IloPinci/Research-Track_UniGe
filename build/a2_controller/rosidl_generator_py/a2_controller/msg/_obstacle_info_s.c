...
bool a2_controller__msg__obstacle_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("a2_controller.msg._obstacle_info.ObstacleInfo", full_classname_dest, 45) == 0);
  }
  a2_controller__msg__ObstacleInfo * ros_message = _ros_message;
  {  // min_distance
  ...
  {  // current_threshold
    PyObject * field = PyObject_GetAttrString(_pymsg, "current_threshold");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->current_threshold = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * a2_controller__msg__obstacle_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("a2_controller.msg._obstacle_info");
  ...
  {  // current_threshold
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->current_threshold);
    {
      int rc = PyObject_SetAttrString(_pymessage, "current_threshold", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }

    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'a2_controller.msg.ObstacleInfo')
            logger.debug(
...
class ObstacleInfo(metaclass=Metaclass_ObstacleInfo):
    ...
    def __init__(self, **kwargs):
        ...
        self.current_threshold = kwargs.get('current_threshold', float())
    ...
    def __eq__(self, other):
        ...
        if self.direction != other.direction:
            return False
        if self.current_threshold != other.current_threshold:
            return False
        return True
    ...
    def current_threshold(self):
        """Message field 'current_threshold'."""
    ...
    def current_threshold(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'current_threshold' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'current_threshold' field must be a float in [-3.402823466e+38, 3.402823466e+38]"

...
#include "a2_controller/msg/detail/obstacle_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const a2_controller::msg::ObstacleInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  a2_controller::msg::ObstacleInfo & ros_message)
{
  // Member: min_distance
  cdr >> ros_message.min_distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = a2_controller::msg::ObstacleInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const a2_controller::msg::ObstacleInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<a2_controller::msg::ObstacleInfo *>(
    untyped_ros_message);
...
{
  return &a2_controller::msg::typesupport_fastrtps_cpp::_ObstacleInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, a2_controller, msg, ObstacleInfo)() {
  return &a2_controller::msg::typesupport_fastrtps_cpp::_ObstacleInfo__handle;
}
